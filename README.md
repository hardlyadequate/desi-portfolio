...
```js
{
  type: "youtube",              // "youtube" | "podcast" | "writing" | "press"
...
Also update the three header links near the top of `index.html`
(`#link-youtube`, `#link-podcast`, `#link-company`) to point to your
YouTube channel, podcast homepage, and company blog.
...
Podcast) and the tag chips can be combined with the search box — everything
narrows the same result set.
